# Generated by Django 5.1 on 2024-08-28 12:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_type', models.CharField(choices=[('order', 'На заказ'), ('in_stock', 'В наличии'), ('pick_up', 'Самовывоз')], default='order', max_length=15, verbose_name='условия получение')),
                ...
                ('category', models.ForeignKey(help_text='Выберите категорию', on_delete=django.db.models.deletion.PROTECT, to='store.category', verbose_name='категория')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='пользователь')),
                ('tags', models.ManyToManyField(to='store.tag', verbose_name='теги')),
            ],
            options={
                'verbose_name': 'товар',
